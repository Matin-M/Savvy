	...
	async execute(client, interaction, Tags) {
		...
		const replyEmbed = new MessageEmbed()
			...
			.addFields(
				...
				{ name: `Free mem`, value: `**${memUtil.freeMemPercentage}%**`, inline: true },
				{ name: `CPU usage`, value: `**${cpuUtil}%**`, inline: true },
				{ name: `Processor type`, value: `**${cpu.model()}**`, inline: true },
				{ name: `Processor core count`, value: `**${cpu.count()}**`, inline: true },
			)
			.setTimestamp()
